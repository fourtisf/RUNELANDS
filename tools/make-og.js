...
// the RUNELANDS isometric REALM from the keyart (cropped so the keyart's own text is off-frame) as a
...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630">
  <defs>
    <linearGradient id="shade" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0" stop-color="#15111f" stop-opacity="0.40"/>
      <stop offset="0.46" stop-color="#15111f" stop-opacity="0.60"/>
      <stop offset="1" stop-color="#120d1c" stop-opacity="0.90"/>
    </linearGradient>
    ...
    <linearGradient id="gold" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0" stop-color="#ffe9a8"/><stop offset="0.5" stop-color="#f0c64a"/><stop offset="1" stop-color="#b8902a"/>
    </linearGradient>
  </defs>

  <rect width="1200" height="630" fill="#15111f"/>
  ...
  <g text-anchor="middle" font-family="DejaVu Sans">
    ${sh(600, 95, 33, 13, 'R U N E L A N D S', 2, 2)}
    <text x="600" y="95" font-size="33" font-weight="bold" letter-spacing="13" fill="#ffe9a8">R U N E L A N D S</text>
    ...
    <text x="600" y="478" font-size="25" font-weight="bold" fill="#ffe9a8">1st $300    2nd $175    3rd $100    4th $75    5th $50    +  $300 Raffle</text>
    ...
    ${sh(600, 611, 19, 0, 'Free Solana fantasy realm MMO · connect your wallet · climb the leaderboard · win real cash', 1, 2)}
    <text x="600" y="611" font-size="19" fill="#b1a4c6">Free Solana fantasy realm MMO · connect your wallet · climb the leaderboard · win real cash</text>
  </g>
</svg>`;
